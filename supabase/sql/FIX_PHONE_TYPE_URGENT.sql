-- ============================================================================
-- CORREÇÃO URGENTE: Tipo incorreto do parâmetro p_phone
-- ============================================================================
-- PROBLEMA: A função insert_profile_safe tem p_phone como UUID, mas deve ser TEXT
-- SOLUÇÃO: Remover versão antiga e criar com tipo correto
-- ============================================================================

BEGIN;

-- Remover TODAS as versões existentes (incluindo a com p_phone uuid)
DO $$
DECLARE
  r RECORD;
BEGIN
...
-- Criar função com tipo CORRETO para p_phone (TEXT, não UUID)
...
-- ============================================================================
-- VERIFICAÇÃO: Confirmar que o tipo está correto
-- ============================================================================
SELECT 
  p.proname as function_name,
...
-- Deve mostrar: p_phone text (não p_phone uuid)
