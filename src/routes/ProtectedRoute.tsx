...
export function ProtectedRoute({ children, requiredRole }: Props) {
  ...
  if (orgStatus && orgStatus !== 'active') {
    console.warn(`🚫 ProtectedRoute - Organização com status '${orgStatus}', redirecionando para checkout`)
  ...
  if (requiredRole) {
    ...
    if (!userRole || !allowedRoles.includes(userRole)) {
      console.warn(`🚫 ProtectedRoute - Role '${userRole}' não permitido. Roles permitidos:`, allowedRoles)
