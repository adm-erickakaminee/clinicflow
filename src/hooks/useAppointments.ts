...
interface UseAppointmentsReturn {
  ...
  updateAppointment: (id: string, data: Partial<AppointmentWithRelations>) => Promise<{ success: boolean; error?: string }>
  optimisticUpdate: (id: string, data: Partial<AppointmentWithRelations>) => AppointmentWithRelations | null
  rollbackUpdate: (previous: AppointmentWithRelations | null) => void
}

export function useAppointments({ startDate, endDate }: UseAppointmentsOptions): UseAppointmentsReturn {
