        ...
        <div className="rounded-3xl bg-white/60 border border-white/40 shadow-xl p-4 space-y-3">
          ...
          <div className="space-y-3">
            {topProcedimentos.map((item, idx) => (
              <div
                key={item.name}
                className="rounded-2xl bg-white/70 border border-white/60 px-3 py-3 flex items-center gap-3 shadow-sm"
              >
            ...
            {topProcedimentos.length === 0 && (
              <p className="text-sm text-gray-600">Nenhum procedimento no mês.</p>
            )}
          </div>
        </div>
        ...
        <div className="rounded-3xl bg-white/60 border border-white/40 shadow-xl p-4 space-y-3">
          ...
          <div className="space-y-3">
            ...
            {clientesMes.length === 0 && (
              <p className="text-sm text-gray-600">Nenhum cliente recorrente no mês.</p>
            )}
          </div>
        </div>
      </div>
