...
export function ClientBookingView({ onClose, onSuccess }: ClientBookingViewProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.ok) {
        toast.success(
          "Solicitação de agendamento enviada! Aguarde a confirmação da recepcionista."
        );
        onSuccess?.();
        onClose();
      } else {
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">
                      {format(selectedSlot.start, "dd 'de' MMMM 'de' yyyy 'às' HH:mm", {
                        locale: ptBR,
                      })}
                    </p>
                  </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <p className="text-sm text-blue-800">
                  ⚠️ Este agendamento será enviado como solicitação. A recepcionista precisará
                  confirmar antes do atendimento.
                </p>
              </div>
            </div>
          )}
