      ...
      {isVisible && (
        ...
        >
          ...
          <div
            className={`absolute ${
              position === "top"
                ? "top-full left-1/2 -translate-x-1/2 border-t-purple-300 border-l-transparent border-r-transparent border-b-transparent"
                : position === "bottom"
                  ? "bottom-full left-1/2 -translate-x-1/2 border-b-purple-300 border-l-transparent border-r-transparent border-t-transparent"
                  : position === "left"
                    ? "left-full top-1/2 -translate-y-1/2 border-l-purple-300 border-t-transparent border-b-transparent border-r-transparent"
