      ...
      <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-3xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <p className="text-xs text-green-700 mt-1">Para atingir suas metas</p>
          </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <p className="text-xs text-purple-700 mt-1">Soma de todos os custos fixos</p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("fixed_cost_rent_cents", parseFloat(e.target.value || "0"))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("fixed_cost_utilities_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("fixed_cost_transport_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("fixed_cost_salary_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("fixed_cost_other_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("profit_margin_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Valor mensal para reinvestimentos e crescimento
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCostField("clinic_fee_cents", parseFloat(e.target.value || "0"))
                  }
                  className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                  placeholder="0.00"
                  min="0"
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Valor mensal que você paga para a clínica
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateCostField("monthly_income_goal_cents", parseFloat(e.target.value || "0"))
                }
                className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                placeholder="0.00"
                min="0"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setGoals((prev) => ({
                    ...prev,
                    hours_available_per_month: value > 0 ? value : 160,
                  }));
                }}
                className="w-full px-4 py-2 rounded-lg bg-white/70 border border-gray-300 text-sm text-gray-900 focus:ring-2 focus:ring-gray-900/20 focus:outline-none"
                placeholder="160"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-lg font-bold text-green-900">
                {formatCurrency(allocationGuide.costs)}
              </p>
            </div>
            ...
            <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-lg font-bold text-blue-900">
                {formatCurrency(allocationGuide.goals)}
              </p>
            </div>
            ...
            <div className="flex items-center justify-between bg-purple-50 border border-purple-200 rounded-lg p-4">
              ...
              <p className="text-lg font-bold text-purple-900">
                {formatCurrency(allocationGuide.investment)}
              </p>
            </div>
          </div>
        </div>
