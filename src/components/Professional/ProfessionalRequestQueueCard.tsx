...
export function ProfessionalRequestQueueCard({
  professionalId,
}: ProfessionalRequestQueueCardProps) {
    ...
    <div className="bg-white/60 backdrop-blur-xl border border-white/40 shadow-xl rounded-3xl p-6">
      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {requests.map((request) => {
          ...
          return (
            <div key={request.id} className="bg-white/80 rounded-xl p-4 border border-gray-200">
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {format(new Date(request.start_time), "dd/MM/yyyy 'às' HH:mm", {
                      locale: ptBR,
                    })}
                  </p>
                </div>
